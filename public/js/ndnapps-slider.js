...
!(function(){
    ...
    var ndnappsBlogtestJavaScript = function(jQuery){
        ...
        var blogtest_data_response = JSON.parse(B64.decode(ndn_slider_data));
            ...
            while (len--) {
                ...
                var frag = (function(){
                    ...
                    if(itemId){
                        ...
                        wrap.innerHTML = '<div class="ndnapps-slider-wrapper" id="ndnapps-slider-wrapper"></div>';
                    }
        ...
        if(jQuery('#ndnapps-slider-wrapper').length){
            jQuery("#ndnapps-slider-wrapper").append(blogtest_data_response);
        }
