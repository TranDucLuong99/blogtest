...
!(function () {
    ...
    var ndnappsBlogtestJavaScript = function (jQuery) {
        var B64 = {
            ...
            encode: function (a) {
                var e, f, g, b = B64.toUtf8(a), c = -1, d = b.length, h = [, ,];
                if (B64.ie) {
            ...
            decode: function (a) {
                ...
                var b = B64.fromUtf8(a), c = 0, d = b.length;
                if (B64.ieo) {
            ...
            toUtf8: function (a) {
                var d, b = -1, c = a.length, e = [];
                if (/^[\x00-\x7f]*$/.test(a)) for (; ++b < c;) e.push(a.charCodeAt(b)); else for (; ++b < c;) d = a.charCodeAt(b), 128 > d ? e.push(d) : 2048 > d ? e.push(192 | d >> 6, 128 | 63 & d) : e.push(224 | d >> 12, 128 | 63 & d >> 6, 128 | 63 & d);
                return e
            },
            fromUtf8: function (a) {
                var c, b = -1, d = [], e = [, ,];
        ...
        var blogtest_data_response = JSON.parse(B64.decode(ndn_blogtest_data));
            ...
            while (len--) {
                ...
                var frag = (function () {
                    ...
                    if (itemId) {
                        ...
                        wrap.innerHTML = '<div class="ndnapps-blogtest-wrapper" id="ndnapps-blogtest-wrapper"></div>';
                    }
        ...
        if (jQuery('#ndnapps-blogtest-wrapper').length) {
            jQuery("#ndnapps-blogtest-wrapper").append(blogtest_data_response);
        }
