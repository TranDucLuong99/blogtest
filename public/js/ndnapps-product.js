...
!(function(){
    ...
    var ndnappsBlogtestJavaScript = function(jQuery){
        ...
        var blogtest_data_response = JSON.parse(B64.decode(ndn_product_data));
            ...
            while (len--) {
                ...
                var frag = (function(){
                    ...
                    if(itemId){
                        ...
                        wrap.innerHTML = '<div class="ndnapps-product-wrapper" id="ndnapps-product-wrapper"></div>';
                    }
        ...
        if(jQuery('#ndnapps-product-wrapper').length){
            jQuery("#ndnapps-product-wrapper").append(blogtest_data_response);
        }
