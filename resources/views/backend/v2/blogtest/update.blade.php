                                ...
                                <div class="position-center">
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Nhập Tên Danh Mục" value="{{$blogtest->name}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="title">Mô Tả Ngắn</label>
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Nhập Mô Tả"value="{{$blogtest->title}}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea  style="resize: none" class="ckeditor form-control" name="description">{{$blogtest->description}}</textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" name="submit" class="btn btn-info">Cập Nhật Tin</button>
                                    </form>
                                </div>
